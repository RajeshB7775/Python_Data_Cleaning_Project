...
def data_cleaning_func(data_path, data_name):
    ...
    # print dealy message
    print(f"Pleas wait for {sec} seconds! Checking file path")
    time.sleep(sec)

    # checking if the past exists
    if not os.path.exists(data_path):
        print("Incorrect path! Try agin with correct path")
        return
    else:
        ...
        if data_path.endswith('.csv'):
            ...
            print("Unkow file type")
            return
        
    # print dealy message
    sec = random.randint(1, 4)
    print(f"Pleas wait for {sec}seconds! Checking total columns and rows")
    time.sleep(sec)

    # showing number of records (for data we used shape to count no. of rows and columns)
    ...
    # print dealy message
    sec = random.randint(1, 4)
    print(f"Pleas wait for {sec}seconds! Checking total duplicates")
    time.sleep(sec)
   ...
   # print dealy message
    sec = random.randint(1, 4)
    print(f"Pleas wait for {sec}seconds! Saving total duplicates rows")
    time.sleep(sec)

    # saving the duplicate
    ...
    print(f"Pleas wait for {sec}seconds! Checking for missing values")
    time.sleep(sec)
    ...
    print(f"Pleas wait for {sec}seconds! Cleaning the dataset")
    time.sleep(sec) 
    ...
    for col in columns:
        ...
        if df[col].dtype in (float, int):
            ...
            # dropping all rows with mising records for non number col
            df.dropna(subset=col, inplace=True)


    # data is cleaned
    print(f"Congras! Dataset is cleaned!: \nNumber of Rows: {df.shape[0]} Number of columns: {df.shape[1]}")

    # print dealy message
    sec = random.randint(1, 5)
    print(f"Pleas wait for {sec} seconds! Exporting datasets")
    time.sleep(sec)
...
if __name__ == "__main__":
    ...
    print("Welcome to Data Cleaning Function!")
    # ask path and file name
    data_path = input("please enter dataset path :")
    data_name = input("please enter dataset name :")

    # calling the function
    data_cleaning_func(data_path, data_name)
